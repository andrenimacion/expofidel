...
var TInvcabgControllerService = /** @class */ (function () {
    function TInvcabgControllerService(http) {
        ...
        this.despachoSaveCab = function (content) { return _this.http.post(_this.apiURL +
            '/despachos_control_cab/save_despacho_cab', content, { observe: 'events', reportProgress: true }); };
        // Guardamos el detalle de lo despachado
        this.despachoSaveDet = function (content) { return _this.http.post(_this.apiURL + '/despachos_control_det/save_despacho_det', content, { observe: 'events', reportProgress: true }); };
